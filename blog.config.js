...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个音乐爱好者🎤🎶, Hi，我是一个计算机实用项目搜罗者💻, Hi，我是一个有趣灵魂😜, 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'QQS', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '<div>音乐爱好者🎤🎶<br/>/数学专业大学生📈<br/>/计算机实用项目搜罗者💻<br/>/有趣灵魂😜</div>', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qqs-fun.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, QQS, Quill, 有趣灵魂', // 网站关键词 英文逗号隔开
  SINCE: process.env.NEXT_SINCE || 2024, // 建站年份

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'qinqiqqsun@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/QwenchC', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'm2g188rs4d', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
